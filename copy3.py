...
#inputFileName = "/eos/user/j/jheikkil/www/triggerStudies/histos_ele_flat2to100_PU200_eg_v23.root"
...
if "PU200_eg" in inputFileName: 
   ...
   bkgTree = "h_cl3d_HMvDR_all_GEN_noMatch"
    ...
    if dirName in k.GetName():
       ...
       for j in dir.GetListOfKeys():
           ...
           for i in range(nEv):
               ...
               if i % 1000 == 0: print "Processed event ", i
               if i<nTrain:
